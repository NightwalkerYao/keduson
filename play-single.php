...
<script type="text/javascript" src="<?=ROOT_SANS;?>/player/jquery-1.12.0.min.js"></script>
 ...
 <!-- <script type="text/javascript" src="<?=ROOT_SANS;?>/player/jquery.jplayer.min.js"></script> -->
 <!-- <script type="text/javascript" src="<?=ROOT_SANS;?>/player/jplayer.playlist.min.js"></script> -->
...
<!-- <link rel="stylesheet" type="text/css" href="<?=ROOT_SANS;?>/css/jplayer.css">  -->
    ...
    <div id="playlist-list">
        <ul id="playlist-audio2">
            ...
            <playlist version="1" xmlns="http://xspf.org/ns/0/">
                ...
                <trackList>
<?php
$piste = $connect_bdd -> prepare("SELECT * FROM musics WHERE code_name=? AND moderation=0 LIMIT 1");
$piste->execute(array(het($_GET['id'])));
$c = $piste->rowCount();
$p = $piste->fetch();
$piste->closeCursor();
if($c){
    echo '<li class="playlist-item" data-type="audio" data-mp3="http://localhost/musicbox/audio/embeded/'.$p['nom_fichier'].'" data-download="'.ROOT_SANS.'/tl/'.$p['code_name'].'" data-title="'.$p['titre'].'" data-artist="'.$p['artiste'].'"></li>';
}else{
