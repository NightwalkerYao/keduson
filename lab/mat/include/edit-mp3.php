<h2>editer une entree : music</h2>
<?php
$mid = (isset($_GET['id']) ? intval($_GET['id']) : 1);
$minfos = $connect_bdd -> prepare("SELECT * FROM musics WHERE id=? LIMIT 1");
...
<form method="post" id="f125">
	<div align="left">
		...
		<tr><td>titre: </td><td><input type="text" name="titre" value="<?=$e->titre;?>" size="55"></td></tr>
		<tr>
		<td>artiste: </td><td><input type="text" name="artiste" value="<?=$e->artiste;?>" size="55"></td></tr>
		<tr>
		<td>album: </td><td><input type="text" name="album" value="<?=$e->album;?>" size="55"></td></tr>
		<tr>
		<td>piste: </td><td><input type="text" name="piste" value="<?=$e->piste;?>" size="55"></td></tr>
		<tr>
		...
		<tr>
		<td>duree:</td><td> <input type="text" name="duree" value="<?=$e->duree;?>" size="55"></td></tr>
		<tr>
		...
		<tr>
		<td>taille: </td><td><input type="text" name="taille" value="<?=$e->taille;?>" size="55"></td></tr>
		<tr>
	...
	<tr> <td colspan="2">
		...
		<input type="submit" name="update" value="Mettre a jour" class="btn-flat blue lighten-2"></center></td></tr>
</table>
	</div>
</form>
